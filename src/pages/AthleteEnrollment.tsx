...
=======
    <div className={isEmbedded ? "" : "min-h-screen bg-background"}>
        ...
        <div className="bg-primary text-primary-foreground py-8">
          <div className="container mx-auto px-4 text-center">
            <div className="w-20 h-20 mx-auto mb-4 bg-white/10 rounded-full p-3 flex items-center justify-center">
              <img src="/logo-white.png" alt="Dance Manager Logo" className="w-full h-full object-contain dark:hidden" />
              <img src="/logo.png" alt="Dance Manager Logo" className="w-full h-full object-contain hidden dark:block" />
            </div>
      ...
      <div className={isEmbedded ? "py-4 max-w-2xl mx-auto" : "container mx-auto px-4 py-8 max-w-2xl"}>
