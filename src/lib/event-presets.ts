export const DISCIPLINES = ["Danze Standard", "Danze Latino Americane", "Combinata 10 Balli", "Combinata 8 Balli", "Classic Showdance", "South American Showdance"];
...
export const STANDARD_LATIN_EVENTS = [
  ...
  { name: "Senior 1 (35/44)", classes: ["D", "C", "B1", "B2", "B3", "A", "AS", "MASTER", "MASTER 1"], minAge: 35, maxAge: 44 },
  { name: "Senior 2 (45/54)", classes: ["D", "C", "B1", "B2", "B3", "A", "AS", "MASTER", "MASTER 2"], minAge: 45, maxAge: 54 },
  { name: "Senior 3a (55/60)", classes: ["D", "C", "B1", "B2", "B3", "A", "AS", "MASTER", "MASTER 3"], minAge: 55, maxAge: 60 },
  { name: "Senior 3b (61/64)", classes: ["D", "C", "B1", "B2", "B3", "A", "AS", "MASTER", "MASTER 3"], minAge: 61, maxAge: 64 },
  { name: "Senior 4a (65/69)", classes: ["D", "C", "B1", "B2", "B3", "A", "AS", "MASTER", "MASTER 4"], minAge: 65, maxAge: 69 },
  { name: "Senior 4b (70/74)", classes: ["D", "C", "B1", "B2", "B3", "A", "AS", "MASTER", "MASTER 4"], minAge: 70, maxAge: 74 },
  ...
  { name: "Over 35", classes: ["D", "C", "B1", "B2", "B3", "A", "AS", "MASTER", "MASTER 1", "MASTER 2", "MASTER 3", "MASTER 4"], minAge: 35 },
  ...
  { name: "Amator A Class", classes: ["A", "A1", "A2", "AS"], minAge: 16 },
  { name: "Adult Rising Stars", classes: ["A", "A1", "A2", "AS"], minAge: 16 },
